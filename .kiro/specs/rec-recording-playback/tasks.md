...
- [ ] 9.1 記録・再生の MonoBehaviour ファサードを実装する（統合）
...
- [ ] 9.2 記録/再生操作の最小 Inspector を実装する
